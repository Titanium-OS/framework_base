...
package com.android.systemui.titanium.header;
...
public class StatusBarHeaderMachine {
    ...
    public static final String STATUS_BAR_HEADER_UPDATE_ACTION = "com.android.systemui.titanium.header.STATUS_BAR_HEADER_UPDATE";
