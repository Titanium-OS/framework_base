...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    protected void makeStatusBarView(@Nullable RegisterStatusBarResult result) {
        ...
        filter.addAction(TitaniumUtils.ACTION_DISMISS_KEYGUARD);
    ...
    private final BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            else if (TitaniumUtils.ACTION_DISMISS_KEYGUARD.equals(action)) {
                if (intent.hasExtra(TitaniumUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(TitaniumUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
