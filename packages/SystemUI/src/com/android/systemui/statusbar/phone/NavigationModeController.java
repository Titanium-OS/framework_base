...
public class NavigationModeController implements Dumpable {
    ...
    private final class TitaniumSettingsObserver extends ContentObserver {
        public TitaniumSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private TitaniumSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new TitaniumSettingsObserver(new Handler());
